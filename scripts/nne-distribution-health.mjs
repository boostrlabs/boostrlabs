...
assert.match(splitApi, /external_recipient_id/);
assert.match(splitApi, /partially_signed/);
...
const docusignWebhook = await readFile(new URL("functions/api/nne/distribution/docusign-webhook.js", root), "utf8");
...
assert.match(docusignWebhook, /payloadSigners/);
assert.match(docusignWebhook, /external_recipient_id/);
assert.match(docusignWebhook, /nne_docusign_webhook_too_large/);
assert.match(docusignWebhook, /envelope-completed/);
