...
const checks = {
  ...
  "functions/parking/omni-jr/ticket/[token].js": ["RECIBO INTERACTIVO", "OMNI JR × BOOSTR", "Powered by BOOSTR Labs", "PARKING ACTIVO", "/api/public/qr", "/app/parking/omni-jr/manager/?token=", "omni-jr-logo-black.svg"],
  ...
  "public/pay/index.html": ["parking-theme", "OMNI JR × BOOSTR", "Powered by BOOSTR Labs", "Plate / Placa", "parking_ticket", "ticketQr", "brand_logo_url", "Activa tu parking", "recibo QR interactivo"],
  "public/assets/omni-jr/omni-jr-logo-black.svg": ["OMNI JR Parking", "viewBox=\"0 0 1024 1024\"", "PARKING"]
};
