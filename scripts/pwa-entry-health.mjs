...
// The public root is now the BOOSTR editorial landing. The installed PWA still opens /app/.
const editorialRoot = root.includes('/assets/agent-os/landing-editorial.js') && root.includes('/assets/agent-os/landing-editorial.css');
if (editorialRoot) {
  need(root, [
    'BOOSTR Labs | Soluciones digitales',
    '/assets/agent-os/landing-editorial.js',
    '/assets/agent-os/landing-editorial.css',
    'maximum-scale=1',
    'user-scalable=no'
  ], 'editorial root');
} else {
