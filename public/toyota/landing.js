const translations = {
  es: {
    draft:"BORRADOR · NO PUBLICAR HASTA APROBACIÓN FINAL DE TÉRMINOS",kicker:"TOYOTA OF HOLLYWOOD × LA CHIQUI",reservedBadge:"PRECIO RESERVADO",julyOnly:"SOLO JULIO",headline:"TACOMA SR5 2026<br><span>CERO MILLAS</span>",perMonth:"AL MES",leaseLabel:"LEASE",heroTerms:"$2,000 DE ENTRADA · 36 MESES · 10,000 MILLAS/AÑO",realUnit:"UNIDAD REAL · TOYOTA OF HOLLYWOOD",financeAlt:"O FINANCIA DESDE",perMonthShort:"/MES",financeTerms:"$2,000 DE ENTRADA · 72 MESES · 5.99% APR",countdownLabel:"TU PRECIO RESERVADO EXPIRA EN",days:"días",hours:"horas",minutes:"min",seconds:"seg",formKicker:"TOYOTA OF HOLLYWOOD × LA CHIQUI",hoursCopy:"Abierto todos los días · 8:30 a. m. a 12:00 a. m.",formTitle:"RESERVA TU PRECIO",formIntro:"Recibe tu pase QR de $299 válido por 72 horas",firstName:"Nombre",lastName:"Apellido",continue:"CONTINUAR",phone:"Teléfono",email:"Email",back:"ATRÁS",score:"Score estimado",choose:"Selecciona una opción",noHistory:"Sin historial de crédito",notSure:"No estoy seguro",consent:"Acepto ser contactado por Toyota of Hollywood y el equipo de Adriana Quintero sobre esta promoción. Mi pase QR no constituye aprobación de crédito ni reserva un vehículo.",submit:"RESERVAR MI PRECIO",legalLead:"OFERTA SUJETA A APROBACIÓN DE CRÉDITO · NO TODOS CALIFICAN · IMPUESTOS Y CARGOS NO INCLUIDOS",legalSummary:"Términos de la oferta",passKicker:"TU PRECIO RESERVADO",passTitle:"PASE CREADO",passCopy:"Muéstralo al equipo de La Chiqui cuando llegues",savePass:"GUARDAR MI QR",passNote:"Válido por 72 horas · no representa aprobación ni reserva de vehículo",step:"Paso",of:"de",required:"Completa los campos requeridos para continuar",sending:"CREANDO…",error:"No pudimos crear tu pase · inténtalo nuevamente",expired:"OFERTA FINALIZADA"
  },
  en: {
    draft:"DRAFT · DO NOT PUBLISH UNTIL FINAL TERMS ARE APPROVED",kicker:"TOYOTA OF HOLLYWOOD × LA CHIQUI",reservedBadge:"RESERVED PRICE",julyOnly:"JULY ONLY",headline:"2026 TACOMA SR5<br><span>ZERO MILES</span>",perMonth:"PER MONTH",leaseLabel:"LEASE",heroTerms:"$2,000 DOWN · 36 MONTHS · 10,000 MILES/YEAR",realUnit:"ACTUAL UNIT · TOYOTA OF HOLLYWOOD",financeAlt:"OR FINANCE FROM",perMonthShort:"/MO",financeTerms:"$2,000 DOWN · 72 MONTHS · 5.99% APR",countdownLabel:"YOUR RESERVED PRICE EXPIRES IN",days:"days",hours:"hours",minutes:"min",seconds:"sec",formKicker:"TOYOTA OF HOLLYWOOD × LA CHIQUI",hoursCopy:"Open daily · 8:30 a.m. to 12:00 a.m.",formTitle:"RESERVE YOUR PRICE",formIntro:"Receive your $299 QR pass valid for 72 hours",firstName:"First name",lastName:"Last name",continue:"CONTINUE",phone:"Phone",email:"Email",back:"BACK",score:"Estimated credit score",choose:"Choose an option",noHistory:"No credit history",notSure:"I'm not sure",consent:"I agree to be contacted by Toyota of Hollywood and Adriana Quintero's team about this promotion. My QR pass is not a credit approval and does not reserve a vehicle.",submit:"RESERVE MY PRICE",legalLead:"OFFER SUBJECT TO CREDIT APPROVAL · NOT ALL CUSTOMERS QUALIFY · TAXES AND FEES NOT INCLUDED",legalSummary:"Offer terms",passKicker:"YOUR RESERVED PRICE",passTitle:"PASS CREATED",passCopy:"Show it to La Chiqui's team when you arrive",savePass:"SAVE MY QR",passNote:"Valid for 72 hours · not a credit approval or vehicle reservation",step:"Step",of:"of",required:"Complete the required fields to continue",sending:"CREATING…",error:"We could not create your pass · please try again",expired:"OFFER ENDED"
  }
};
