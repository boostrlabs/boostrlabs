...
export async function onRequest(context) {
  ...
  if (shouldInjectTheme && !html.includes('id="boostr-system-theme-style"')) {
    html = injectBeforeHeadClose(html, `${themeBootstrap}${themeStyle}`);
  }
  if (shouldInjectTheme && !/boostr-theme\/theme-runtime\.js/.test(html)) {
    html = injectBeforeBody(html, themeRuntimeScript);
  }
